...
| x1, x3, y1, y2, y4, c3, d2, d3 | `glob` | `'**/*'` como primer movimiento | por decidir |
| c2 | `grep` | leer `patterns.py` ya localizado, en vez de `read_file` | rival |
| x1, x2, x3, c3, d4 | `read_file` | `offset: 1, limit: 220/250/80/40` sobre ficheros de ≤40 líneas | descripción |
...
| d2, d3, d4, d5 | `write_file` | relectura del fichero recién escrito, con el sello reforzado en el acuse | gpt-5.x |
